  ...
  return (
    <Modal.Root state={state}>
      ...
      <Modal.Backdrop className="inbox-modal-backdrop">
        <Modal.Container className="inbox-account-modal" placement="center">
          <Modal.Dialog>
            <form onSubmit={submit}>
                ...
                <div className="inbox-account-modal__type">
                  <label>
                    <input
                      ...
                      name="provider"
                      onChange={() =>
                        setForm((current) => ({ ...current, provider: "imap" }))
                      }
                      type="radio"
                    />
                    IMAP
                  ...
                  <label>
                    <input
                      ...
                      name="provider"
                      onChange={() =>
                        setForm((current) => ({ ...current, provider: "zoho" }))
                      }
                      type="radio"
                    />
                    Zoho
              ...
              <Modal.Footer className="inbox-account-modal__footer">
                ...
                <Button isDisabled={isPending} size="sm" type="submit">
