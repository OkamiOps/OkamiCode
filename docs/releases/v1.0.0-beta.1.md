...
[Leia em português do Brasil](https://github.com/OkamiOps/OkamiCode/blob/main/docs/releases/v1.0.0-beta.1.pt-BR.md)
...
You can also [build from source](../../README.md#run-from-source).
...
See the [English changelog](../../CHANGELOG.md) or [PT-BR changelog](../../CHANGELOG.pt-BR.md).
