...
The attached archive contains an **unsigned and non-notarized** Apple Silicon `.app` bundle:

1. Download and unzip `OkamiCode-v1.0.0-beta.1-macOS-arm64.zip`.
2. Move `OkamiCode.app` to `/Applications`.
3. Open it. If macOS blocks the first launch, review and allow it under **System Settings → Privacy & Security**.
